...
namespace VB.Controllers
{
    public class DoctorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DoctorID,Name,Description,Status")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorID,Name,Description,Status")] Doctor doctor)
        {
